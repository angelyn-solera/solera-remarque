 const editorStates = [];
        ...
        let currentAccess = 'anyone'; // Default access level
        ...
        function changeFontSize() {
            ...
            document.execCommand("fontSize", false, "7"); // Always use size 7
        ...
        function startDrawing() {
            ...
            // Create canvas at cursor position
            const selection = window.getSelection();
            if (selection.rangeCount > 0) {
                const range = selection.getRangeAt(0);
        ...
        function setupCanvasDrawing(canvas) {
            ...
            // Update drawing settings when tools change
            ...
            // Watch for changes in drawing tools
